...
/*
 ...
 (jslint is happy about this); if false, then the commons "function()" output is used,
    ...
    unpack: function (str) {
        ...
        if (P_A_C_K_E_R.detect(str)) {
            try {
                ...
                // well, it failed. we'll just return the original, instead of crashing on authentication.
            }
        }
        return str;
    },
